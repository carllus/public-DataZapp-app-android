...
public abstract class Evaluator {
    ...
    public static final class C0453Id extends Evaluator {

        /* renamed from: id */
        private String f731id;

        public C0453Id(String id) {
            this.f731id = id;
        }

        public boolean matches(Element root, Element element) {
            return this.f731id.equals(element.mo4617id());
        }

        public String toString() {
            return String.format("#%s", new Object[]{this.f731id});
        }
    }
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        /* renamed from: a */
        protected final int f729a;

        /* renamed from: b */
        protected final int f730b;
        ...
        public boolean matches(Element root, Element element) {
            ...
            if (this.f729a == 0) {
                ...
                return true;
            } else if ((pos - this.f730b) * this.f729a < 0 || (pos - this.f730b) % this.f729a != 0) {
                return false;
            } else {
                return true;
            }
        ...
        public String toString() {
            if (this.f729a == 0) {
                return String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f730b)});
            } else if (this.f730b == 0) {
                return String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.f729a)});
            } else {
                return String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f729a), Integer.valueOf(this.f730b)});
            }
        }
    }
