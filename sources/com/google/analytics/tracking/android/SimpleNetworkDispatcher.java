...
class SimpleNetworkDispatcher implements Dispatcher {
    ...
    public boolean okToDispatch() {
        ...
        Log.m528v("...no network connectivity");
        return false;
    }
            ...
            if (url != null) {
                ...
                if (request != null) {
                    ...
                    if (params.length() > 8192) {
                        ...
                        Log.m527i("Dry run enabled. Hit not actually sent.");
                    } else {
                        if (firstSend) {
                            try {
    ...
    private void logDebugInformation(HttpEntityEnclosingRequest request) {
        ...
        if (request.getEntity() != null) {
            try {
                ...
                Log.m528v("Error Writing hit to log...");
            }
        }
        Log.m528v(httpHeaders.toString());
    }
    ...
    public URL getUrl(Hit hit) {
        ...
        try {
            ...
            Log.m526e("Error trying to parse the hardcoded host url. This really shouldn't happen.");
            return null;
        }
    }
