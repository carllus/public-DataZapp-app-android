...
public class GAServiceManager extends ServiceManager {
    ...
    public synchronized void dispatchLocalHits() {
        if (this.thread == null) {
            Log.m528v("Dispatch call queued. Dispatch will run once initialization is complete.");
    ...
    public synchronized void setLocalDispatchPeriod(int dispatchPeriodInSeconds2) {
        if (this.handler == null) {
            Log.m528v("Dispatch period set with null handler. Dispatch will run once initialization is complete.");
    ...
    public void setForceLocalDispatch() {
        if (this.thread == null) {
            Log.m528v("setForceLocalDispatch() queued. It will be called once initialization is complete.");
    ...
    public synchronized void updatePowerSaveMode(boolean storeIsEmpty2, boolean connected2) {
        if (!(this.storeIsEmpty == storeIsEmpty2 && this.connected == connected2)) {
            ...
            Log.m528v("PowerSaveMode " + ((storeIsEmpty2 || !connected2) ? "initiated." : "terminated."));
