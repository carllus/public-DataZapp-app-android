...
public class ExceptionReporter implements Thread.UncaughtExceptionHandler {
    ...
    public ExceptionReporter(Tracker tracker, ServiceManager serviceManager, Thread.UncaughtExceptionHandler originalHandler, Context context) {
        if (tracker == null) {
            ...
            Log.m528v("ExceptionReporter created, original handler is " + (originalHandler == null ? "null" : originalHandler.getClass().getName()));
        }
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        Log.m528v("Tracking Exception: " + description);
        ...
        if (this.mOriginalHandler != null) {
            Log.m528v("Passing exception to original handler.");
