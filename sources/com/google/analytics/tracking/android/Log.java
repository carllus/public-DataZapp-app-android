...
public class Log {
    ...
    /* renamed from: e */
    public static void m526e(String msg) {
        Logger l = getLogger();
        if (l != null) {
            l.error(msg);
        }
    ...
    /* renamed from: e */
    public static void m525e(Exception e) {
        Logger l = getLogger();
        if (l != null) {
            l.error(e);
        }
    ...
    /* renamed from: i */
    public static void m527i(String msg) {
        Logger l = getLogger();
        if (l != null) {
            l.info(msg);
        }
    ...
    /* renamed from: v */
    public static void m528v(String msg) {
        Logger l = getLogger();
        if (l != null) {
            l.verbose(msg);
        }
    ...
    /* renamed from: w */
    public static void m529w(String msg) {
        Logger l = getLogger();
        if (l != null) {
            l.warn(msg);
        }
