...
public class EasyTracker extends Tracker {
    ...
    private void loadParameters() {
        ...
        Log.m528v("Starting EasyTracker.");
        ...
        if (!(logLevelString == null || (logLevel = getLogLevelFromString(logLevelString)) == null)) {
            Log.m528v("[EasyTracker] log level loaded: " + logLevel);
        ...
        Log.m528v("[EasyTracker] sample rate loaded: " + sampleRate);
        int dispatchPeriod = this.mParameterFetcher.getInt("ga_dispatchPeriod", 1800);
        Log.m528v("[EasyTracker] dispatch period loaded: " + dispatchPeriod);
        ...
        Log.m528v("[EasyTracker] session timeout loaded: " + this.mSessionTimeout);
        ...
        Log.m528v("[EasyTracker] auto activity tracking loaded: " + this.mIsAutoActivityTracking);
        ...
        if (isAnonymizeIpEnabled) {
            ...
            Log.m528v("[EasyTracker] anonymize ip loaded: " + isAnonymizeIpEnabled);
        }
        ...
        if (this.mIsReportUncaughtExceptionsEnabled) {
            ...
            Log.m528v("[EasyTracker] report uncaught exceptions loaded: " + this.mIsReportUncaughtExceptionsEnabled);
        }
