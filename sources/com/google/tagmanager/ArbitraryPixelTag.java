...
class ArbitraryPixelTag extends TrackingTag {
    ...
    static final String ARBITRARY_PIXEL_UNREPEATABLE = ("gtm_" + f690ID + "_unrepeatable");

    /* renamed from: ID */
    private static final String f690ID = FunctionType.ARBITRARY_PIXEL.toString();
        ...
        if (unrepeatableId == null || !idProcessed(unrepeatableId)) {
            ...
            if (additionalParamsList != null) {
                ...
                if (!(l instanceof List)) {
                    Log.m542e("ArbitraryPixel: additional params not a list: not sending partial hit: " + uriBuilder.build().toString());
                    return;
                }
                for (Object m : (List) l) {
                    if (!(m instanceof Map)) {
                        Log.m542e("ArbitraryPixel: additional params contains non-map: not sending partial hit: " + uriBuilder.build().toString());
                        return;
                    }
            ...
            Log.m546v("ArbitraryPixel: url = " + uri);
