...
public class ExperimentMacroHelper {
    public static void handleExperimentSupplemental(DataLayer dataLayer, Serving.Supplemental supplemental) {
        if (supplemental.experimentSupplemental == null) {
            Log.m548w("supplemental missing experimentSupplemental");
            return;
        }
    ...
    private static void setRandomValues(com.google.tagmanager.DataLayer r21, com.google.analytics.containertag.proto.Serving.GaExperimentSupplemental r22) {
        /*
            r0 = r22
        ...
        L_0x0006:
            ...
            com.google.tagmanager.Log.m548w(r16)
        L_0x0015:
            int r5 = r5 + 1
            goto L_0x0006
        L_0x0018:
    ...
    private static Map<Object, Object> valueToMap(TypeSystem.Value value) {
        ...
        Log.m548w("value: " + valueAsObject + " is not a map value, ignored.");
        return null;
    }
}
