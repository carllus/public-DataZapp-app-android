...
public class C0238a {
    ...
    /* renamed from: a */
    private static boolean f634a = Log.isLoggable("GoogleAdsAssertion", 3);
    ...
    public static class C0239a extends Error {
    ...
    private static void m477c(boolean z, String str) {
        if ((Log.isLoggable("GoogleAdsAssertion", 3) || f634a) && !z) {
            C0239a aVar = new C0239a(str);
